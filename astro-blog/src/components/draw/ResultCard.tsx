...
export default function ResultCard({ result, imageDataUrl }: Props) {
  return (
    <div className="grid gap-6 md:grid-cols-[260px,1fr]">
      ...
      <div className="space-y-3">
        <div className="text-3xl font-bold text-gray-900">{result.score}点</div>
        <div className="text-sm text-gray-600">{result.oneLiner}</div>
